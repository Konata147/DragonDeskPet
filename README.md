...
V0.2.1 已完成，在完整保留桌宠体验的基础上加入“桌面内容问 AI”：区域截图、用户主动读取的剪贴板文字或图片，以及拖入桌宠的本地图片，都会先预览或填入输入框，确认发送后才会上传给当前模型。本次补丁还优化了快捷栏、放大布局和全屏程序兼容性。
...
1. 从 [DragonDeskPet V0.2.1 Release](https://github.com/Konata147/DragonDeskPet/releases/tag/v0.2.1) 下载 `DragonDeskPet-v0.2.1-win-x64.zip`。
...
```powershell
.\scripts\publish-release.ps1 -Version 0.2.1
```
